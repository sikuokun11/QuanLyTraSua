...
import com.example.serversideapp.Common.DirectionJSONParser;
    ...
    private void displayLocation() {
                ...
                && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            if(mLastLocation != null) {
                ...
                // Dua con tro vi tri ve vi tri hien tai
                ...
                // Luu con tro vi tri vao Order va chi duong
               drawRoute(yourLocation,Common.currunent_Request.getAddress());
            }
            else {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    MarkerOptions marker = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Order of" + Common.currunent_Request.getPhone())
